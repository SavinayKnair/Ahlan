...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "boutique homestay Port Blair",
    "safe homestay for solo female travelers Andaman",
    "best B&B in Port Blair",
    "luxury accommodation near Port Blair airport",
    "homestay with high-speed wifi Andaman",
    "top rated homestay Port Blair",
    "Andaman tour packages with stay",
    "homestay near Aberdeen Bazaar",
    "couple friendly homestay Port Blair",
    "digital nomad stay Andaman",
    "workation Andaman homestay",
    "homestay near Veer Savarkar Airport",
    "premium bed and breakfast Port Blair",
    "Andaman vacation rentals",
    "luxury villa Port Blair",
    "best place to stay in Port Blair for tourists",
  ].join(", "),
