...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Ahlan Homestay",
    "Ahlan Port Blair",
    "Ahlan Homestay Port Blair",
    "Ahlan Homestays Port Blair",
    "Ahlan Andaman",
    "Ahlan Stay Port Blair",
    "Ahlan Rooms Port Blair",
    "Best Homestay Port Blair",
    "Best Hotel Port Blair",
    "Best Stay Port Blair",
    "Best Rooms Port Blair",
    "Premium Homestay Port Blair",
    "Luxury Homestay Port Blair",
    "Luxury Stay Port Blair",
    "Premium Rooms Port Blair",
    "Deluxe Rooms Port Blair",
    "Family Homestay Port Blair",
    "Family Hotel Port Blair",
    "Couple Friendly Homestay Port Blair",
    "Honeymoon Stay Port Blair",
    "Resort Port Blair",
    "Best Resort Port Blair",
    "Hotel in Port Blair",
    "Hotels in Port Blair Andaman",
    "Rooms in Port Blair",
    "Port Blair Homestay",
    "Port Blair Luxury Stay",
    "Port Blair Premium Rooms",
    "Gold Category Homestay Port Blair",
    "Top Rated Homestay Port Blair",
    "Affordable Luxury Stay Port Blair",
    "Budget Premium Hotel Port Blair",
    "Airport Stay Port Blair",
    "Hotel Near Airport Port Blair",
    "Best Accommodation Port Blair",
    "Where to Stay in Port Blair",
    "Stay in Andaman",
    "Luxury Stay in Andaman",
    "Best Hotel in Andaman",
    "Andaman Homestay",
    "Andaman Luxury Rooms",
    "Port Blair Booking",
    "Port Blair Hotel Booking",
    "Port Blair Room Booking",
    "Vacation Stay Port Blair",
    "Holiday Stay Port Blair",
    "Tourist Stay Port Blair",
    "Best Guest House Port Blair",
    "Premium Guest House Port Blair",
    "Boutique Stay Port Blair",
    "Sea Vacation Stay Port Blair",
    "Island Stay Port Blair",
    "Comfortable Rooms Port Blair",
    "Spacious Rooms Port Blair",
    "Clean Rooms Port Blair",
    "Luxury Rooms Andaman",
    "Best Homestay Andaman",
    "Premium Stay Andaman",
    "Safe Homestay for Solo Travelers",
    "Hygienic Stay Port Blair",
    "Andaman Trip Planning",
    "Best Places to Visit in Port Blair",
    "Homestay with Breakfast Port Blair",
    "Andaman Island Travel Guides",
    "Luxury B&B Andaman",
    "Port Blair Sightseeing Stay",
  ].join(", "),
