...
export const metadata: Metadata = {
  title: "Ahlan Homestay | Homestay Near Cellular Jail Port Blair | Andaman",
  description: "Stay near the historic Cellular Jail in Port Blair at Ahlan Homestay. Premium deluxe AC rooms just minutes from Cellular Jail. Don't miss the famous Sound & Light Show. Book now!",
  ...
  alternates: { canonical: "https://ahlanandaman.in/near-cellular-jail-stay" },
};
    ...
    <main className="pt-24 min-h-screen bg-pearl dark:bg-midnight">
      <div className="bg-gradient-ocean py-20 text-center text-white px-4">
        ...
        <p className="font-sans text-white/80 text-xl max-w-2xl mx-auto mb-8">
          Ahlan Homestay is just 2.5 km from the historic Cellular Jail, Port Blair. Don&apos;t miss the iconic Sound & Light Show!
        </p>
        <a href="https://wa.me/919434281386?text=Hi! I'm visiting Cellular Jail and need a room nearby at Ahlan Homestay." target="_blank" rel="noopener noreferrer" className="btn-primary text-base py-4 px-10 inline-block">
          📍 Book Nearby Stay
        </a>
      </div>
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <p className="text-warmgray dark:text-gray-300 font-sans leading-relaxed mb-8">
          The Cellular Jail (Kala Pani) is Port Blair&apos;s most iconic landmark — a colonial-era prison that bears testament to India&apos;s freedom struggle. The famous Sound & Light Show every evening is a must-see experience. Staying at Ahlan Homestay puts you just <strong>2.5 km from Cellular Jail</strong>, making it the most convenient base for your visit.
        </p>
