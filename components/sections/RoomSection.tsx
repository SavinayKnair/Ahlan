...
const rooms = [
  {
    ...
    desc: "Wake up to tropical greenery. Spacious deluxe room with premium furnishings, king-size bed, and premium ensuite bathroom.",
...
export default function RoomSection() {
  ...
  return (
    <section id="rooms" className="section-padding bg-pearl dark:bg-[#0A0A0F]">
